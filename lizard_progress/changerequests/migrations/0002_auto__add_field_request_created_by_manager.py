...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.created_by_manager'
        db.add_column(u'changerequests_request', 'created_by_manager',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.created_by_manager'
        db.delete_column(u'changerequests_request', 'created_by_manager')
