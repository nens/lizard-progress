...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.the_geom'
        db.add_column('changerequests_request', 'the_geom',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(srid=28992, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.the_geom'
        db.delete_column('changerequests_request', 'the_geom')
