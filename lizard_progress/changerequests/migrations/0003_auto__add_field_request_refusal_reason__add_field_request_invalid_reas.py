...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.refusal_reason'
        db.add_column('changerequests_request', 'refusal_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Request.invalid_reason'
        db.add_column('changerequests_request', 'invalid_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.refusal_reason'
        db.delete_column('changerequests_request', 'refusal_reason')

        # Deleting field 'Request.invalid_reason'
        db.delete_column('changerequests_request', 'invalid_reason')
