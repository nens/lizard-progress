...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.possible_request'
        db.add_column('changerequests_request', 'possible_request',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['changerequests.PossibleRequest'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'PossibleRequest.requested'
        db.add_column('changerequests_possiblerequest', 'requested',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.possible_request'
        db.delete_column('changerequests_request', 'possible_request_id')

        # Deleting field 'PossibleRequest.requested'
        db.delete_column('changerequests_possiblerequest', 'requested')
    ...
    models = {
        ...
        'changerequests.possiblerequest': {
        ...
        'changerequests.request': {
            ...
            'possible_request': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['changerequests.PossibleRequest']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
