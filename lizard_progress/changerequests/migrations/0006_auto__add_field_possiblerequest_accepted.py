...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PossibleRequest.accepted'
        db.add_column('changerequests_possiblerequest', 'accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PossibleRequest.accepted'
        db.delete_column('changerequests_possiblerequest', 'accepted')
