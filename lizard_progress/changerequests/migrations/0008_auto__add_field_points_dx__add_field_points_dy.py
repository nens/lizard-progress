...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Points.dx'
        db.add_column('changerequests_points', 'dx',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Points.dy'
        db.add_column('changerequests_points', 'dy',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Points.dx'
        db.delete_column('changerequests_points', 'dx')

        # Deleting field 'Points.dy'
        db.delete_column('changerequests_points', 'dy')
