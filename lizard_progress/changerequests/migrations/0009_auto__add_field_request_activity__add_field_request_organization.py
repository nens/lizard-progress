...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.activity'
        db.add_column(u'changerequests_request', 'activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Activity'], null=True),
                      keep_default=False)

        # Adding field 'Request.organization'
        db.add_column(u'changerequests_request', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Organization'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.activity'
        db.delete_column(u'changerequests_request', 'activity_id')

        # Deleting field 'Request.organization'
        db.delete_column(u'changerequests_request', 'organization_id')
