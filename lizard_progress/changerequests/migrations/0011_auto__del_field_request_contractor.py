...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Request.contractor'
        db.delete_column(u'changerequests_request', 'contractor_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Request.contractor'
        raise RuntimeError("Cannot reverse this migration. 'Request.contractor' and its values cannot be restored.")
