...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Request.mtype'
        db.delete_column(u'changerequests_request', 'mtype_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Request.mtype'
        raise RuntimeError("Cannot reverse this migration. 'Request.mtype' and its values cannot be restored.")
