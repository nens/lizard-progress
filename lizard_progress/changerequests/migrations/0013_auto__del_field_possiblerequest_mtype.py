...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PossibleRequest.mtype'
        db.delete_column(u'changerequests_possiblerequest', 'mtype_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PossibleRequest.mtype'
        raise RuntimeError("Cannot reverse this migration. 'PossibleRequest.mtype' and its values cannot be restored.")
