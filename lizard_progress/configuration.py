...
CONFIG_OPTIONS = {
    ...
    'maximum_location_distance_use_2components': Option(
        ...
        short_description='Gebruik afstandscontrole opgesplitst in twee componenten',
    ...
    'maximum_location_distance_parallel': Option(
        ...
        type='float',
        default='5',
        only_for_error='TOO_FAR_FROM_LOCATION_PARA',
        for_project=False,
        applies_to_measurement_types=['dwarsprofiel'],
    ),
    'maximum_location_distance_orthogonal': Option(
        ...
        type='float',
        default='5',
        only_for_error='TOO_FAR_FROM_LOCATION_ORTHO',
        for_project=False,
        applies_to_measurement_types=['dwarsprofiel'],
    ),
