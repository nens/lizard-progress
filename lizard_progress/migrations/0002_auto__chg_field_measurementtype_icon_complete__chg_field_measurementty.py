...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MeasurementType.icon_complete'
        db.alter_column('lizard_progress_measurementtype', 'icon_complete', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'MeasurementType.icon_missing'
        db.alter_column('lizard_progress_measurementtype', 'icon_missing', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Changing field 'MeasurementType.icon_complete'
        db.alter_column('lizard_progress_measurementtype', 'icon_complete', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'MeasurementType.icon_missing'
        db.alter_column('lizard_progress_measurementtype', 'icon_missing', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
