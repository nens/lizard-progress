...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Measurement.is_point'
        db.add_column(u'lizard_progress_measurement', 'is_point',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Measurement.the_geom'
        db.alter_column(u'lizard_progress_measurement', 'the_geom', self.gf('django.contrib.gis.db.models.fields.GeometryField')(srid=28992, null=True))

    def backwards(self, orm):
        # Deleting field 'Measurement.is_point'
        db.delete_column(u'lizard_progress_measurement', 'is_point')


        # Changing field 'Measurement.the_geom'
        db.alter_column(u'lizard_progress_measurement', 'the_geom', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=28992, null=True))
