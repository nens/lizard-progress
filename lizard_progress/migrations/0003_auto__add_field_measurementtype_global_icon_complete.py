...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MeasurementType.global_icon_complete'
        db.add_column('lizard_progress_measurementtype', 'global_icon_complete', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MeasurementType.global_icon_complete'
        db.delete_column('lizard_progress_measurementtype', 'global_icon_complete')
