...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AvailableMeasurementType.has_only_point_locations'
        db.add_column(u'lizard_progress_availablemeasurementtype', 'has_only_point_locations',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'AvailableMeasurementType.keep_updated_measurements'
        db.add_column(u'lizard_progress_availablemeasurementtype', 'keep_updated_measurements',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AvailableMeasurementType.has_only_point_locations'
        db.delete_column(u'lizard_progress_availablemeasurementtype', 'has_only_point_locations')

        # Deleting field 'AvailableMeasurementType.keep_updated_measurements'
        db.delete_column(u'lizard_progress_availablemeasurementtype', 'keep_updated_measurements')
