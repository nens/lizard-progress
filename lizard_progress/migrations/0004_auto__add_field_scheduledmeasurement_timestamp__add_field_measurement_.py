...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScheduledMeasurement.timestamp'
        db.add_column('lizard_progress_scheduledmeasurement', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 2, 16), blank=True), keep_default=False)

        # Adding field 'Measurement.filename'
        db.add_column('lizard_progress_measurement', 'filename', self.gf('django.db.models.fields.CharField')(default='', max_length=1000), keep_default=False)

        # Adding field 'Measurement.timestamp'
        db.add_column('lizard_progress_measurement', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 2, 16), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScheduledMeasurement.timestamp'
        db.delete_column('lizard_progress_scheduledmeasurement', 'timestamp')

        # Deleting field 'Measurement.filename'
        db.delete_column('lizard_progress_measurement', 'filename')

        # Deleting field 'Measurement.timestamp'
        db.delete_column('lizard_progress_measurement', 'timestamp')
    ...
    models = {
        ...
        'lizard_progress.measurementtype': {
            ...
            'global_icon_complete': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
