...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_progress_organization', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal('lizard_progress', ['Organization'])

        # Adding model 'UserProfile'
        db.create_table('lizard_progress_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Organization'])),
        ))
        db.send_create_signal('lizard_progress', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'Organization'
        db.delete_table('lizard_progress_organization')

        # Deleting model 'UserProfile'
        db.delete_table('lizard_progress_userprofile')
