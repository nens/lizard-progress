...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.planned_date'
        db.add_column(u'lizard_progress_location', 'planned_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.planned_date'
        db.delete_column(u'lizard_progress_location', 'planned_date')
