...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('lizard_progress_contractor', 'user_id')

        # Adding field 'Contractor.organization'
        db.add_column('lizard_progress_contractor', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Organization'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Contractor.user'
        db.add_column('lizard_progress_contractor', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Contractor.organization'
        db.delete_column('lizard_progress_contractor', 'organization_id')
