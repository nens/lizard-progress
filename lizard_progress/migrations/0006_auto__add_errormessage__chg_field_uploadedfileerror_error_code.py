...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_progress_errormessage', (
        ...
        db.send_create_signal('lizard_progress', ['ErrorMessage'])


        # Changing field 'UploadedFileError.error_code'
        db.alter_column('lizard_progress_uploadedfileerror', 'error_code', self.gf('django.db.models.fields.CharField')(max_length=30))
        # Adding M2M table for field errors on 'Organization'
        db.create_table('lizard_progress_organization_errors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organization', models.ForeignKey(orm['lizard_progress.organization'], null=False)),
            ('errormessage', models.ForeignKey(orm['lizard_progress.errormessage'], null=False))
        ))
        db.create_unique('lizard_progress_organization_errors', ['organization_id', 'errormessage_id'])


    def backwards(self, orm):
        # Deleting model 'ErrorMessage'
        db.delete_table('lizard_progress_errormessage')


        # Changing field 'UploadedFileError.error_code'
        db.alter_column('lizard_progress_uploadedfileerror', 'error_code', self.gf('django.db.models.fields.CharField')(max_length=10))
