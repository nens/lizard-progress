...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'lizard_progress_location', 'location_type',
                      self.gf('django.db.models.fields.CharField')(default=u'point', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.location_type'
        db.delete_column(u'lizard_progress_location', 'location_type')
