...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('lizard_progress_project', ['name'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('lizard_progress_project', ['name'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 30, 14, 1, 43, 467985)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 30, 14, 1, 43, 467899)'}),
