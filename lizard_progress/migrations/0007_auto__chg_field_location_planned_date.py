...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.planned_date'
        db.alter_column(u'lizard_progress_location', 'planned_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Location.planned_date'
        db.alter_column(u'lizard_progress_location', 'planned_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
