...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for name in (
            ...
            'Foto',
            'Meting'):
            o = orm.AvailableMeasurementType.objects.create(
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 8, 42, 4, 331792)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 8, 42, 4, 331712)'}),
