...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'lizard_progress_project', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=60))

    def backwards(self, orm):

        # Changing field 'Project.slug'
        db.alter_column(u'lizard_progress_project', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
