...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_progress_exportrun', (
            ...
            ('measurement_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.AvailableMeasurementType'])),
        ...
        db.send_create_signal('lizard_progress', ['ExportRun'])

        # Adding unique constraint on 'ExportRun', fields ['project', 'contractor', 'measurement_type', 'exporttype']
        db.create_unique('lizard_progress_exportrun', ['project_id', 'contractor_id', 'measurement_type_id', 'exporttype'])


    def backwards(self, orm):
        # Removing unique constraint on 'ExportRun', fields ['project', 'contractor', 'measurement_type', 'exporttype']
        db.delete_unique('lizard_progress_exportrun', ['project_id', 'contractor_id', 'measurement_type_id', 'exporttype'])

        # Deleting model 'ExportRun'
        db.delete_table('lizard_progress_exportrun')
