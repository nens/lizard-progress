...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizationConfig.measurement_type'
        db.add_column(u'lizard_progress_organizationconfig', 'measurement_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.AvailableMeasurementType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganizationConfig.measurement_type'
        db.delete_column(u'lizard_progress_organizationconfig', 'measurement_type_id')
