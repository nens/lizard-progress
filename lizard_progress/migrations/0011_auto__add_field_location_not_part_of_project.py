...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.not_part_of_project'
        db.add_column(u'lizard_progress_location', 'not_part_of_project',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.not_part_of_project'
        db.delete_column(u'lizard_progress_location', 'not_part_of_project')
