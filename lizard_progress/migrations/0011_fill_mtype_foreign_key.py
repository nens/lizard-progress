...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for measurement_type in orm.MeasurementType.objects.all():
            try:
                mtype = orm.AvailableMeasurementType.objects.get(
                    slug=measurement_type.slug)
            except orm.AvailableMeasurementType.DoesNotExist:
                raise Exception('slug "{0}" does not exist!'.format(
                        measurement_type.slug))
            measurement_type.mtype = mtype
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 8, 56, 52, 474224)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 8, 56, 52, 474147)'}),
