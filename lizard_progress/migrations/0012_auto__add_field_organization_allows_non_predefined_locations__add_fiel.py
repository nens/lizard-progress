...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.allows_non_predefined_locations'
        db.add_column('lizard_progress_organization', 'allows_non_predefined_locations',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AvailableMeasurementType.likes_predefined_locations'
        db.add_column('lizard_progress_availablemeasurementtype', 'likes_predefined_locations',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('lizard_progress_organization', 'allows_non_predefined_locations')

        # Deleting field 'AvailableMeasurementType.likes_predefined_locations'
        db.delete_column('lizard_progress_availablemeasurementtype', 'likes_predefined_locations')
