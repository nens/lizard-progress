...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UploadLog.activity'
        db.add_column(u'lizard_progress_uploadlog', 'activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Activity'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UploadLog.activity'
        db.delete_column(u'lizard_progress_uploadlog', 'activity_id')
