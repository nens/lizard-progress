...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'MeasurementType', fields ['project', 'slug']
        db.delete_unique('lizard_progress_measurementtype', ['project_id', 'slug'])

        # Removing unique constraint on 'MeasurementType', fields ['project', 'name']
        db.delete_unique('lizard_progress_measurementtype', ['project_id', 'name'])

        # Deleting field 'MeasurementType.slug'
        db.delete_column('lizard_progress_measurementtype', 'slug')

        # Deleting field 'MeasurementType.name'
        db.delete_column('lizard_progress_measurementtype', 'name')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'MeasurementType.slug'
        raise RuntimeError("Cannot reverse this migration. 'MeasurementType.slug' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MeasurementType.name'
        raise RuntimeError("Cannot reverse this migration. 'MeasurementType.name' and its values cannot be restored.")

        # Adding unique constraint on 'MeasurementType', fields ['project', 'name']
        db.create_unique('lizard_progress_measurementtype', ['project_id', 'name'])

        # Adding unique constraint on 'MeasurementType', fields ['project', 'slug']
        db.create_unique('lizard_progress_measurementtype', ['project_id', 'slug'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 10, 47, 56, 435349)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 10, 47, 56, 435077)'}),
