...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UploadLog.mtype'
        db.delete_column(u'lizard_progress_uploadlog', 'mtype_id')

        # Deleting field 'UploadLog.project'
        db.delete_column(u'lizard_progress_uploadlog', 'project_id')

        # Deleting field 'UploadLog.uploading_organization'
        db.delete_column(u'lizard_progress_uploadlog', 'uploading_organization_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UploadLog.mtype'
        raise RuntimeError("Cannot reverse this migration. 'UploadLog.mtype' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'UploadLog.project'
        raise RuntimeError("Cannot reverse this migration. 'UploadLog.project' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'UploadLog.uploading_organization'
        raise RuntimeError("Cannot reverse this migration. 'UploadLog.uploading_organization' and its values cannot be restored.")
