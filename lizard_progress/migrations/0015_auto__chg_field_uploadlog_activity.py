...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UploadLog.activity'
        db.alter_column(u'lizard_progress_uploadlog', 'activity_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lizard_progress.Activity']))

    def backwards(self, orm):

        # Changing field 'UploadLog.activity'
        db.alter_column(u'lizard_progress_uploadlog', 'activity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Activity'], null=True))
