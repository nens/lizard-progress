...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # In all scheduled measurements, set temp_location to the
        # unique_id field of the scheduled measurement's location.
        for sm in orm.ScheduledMeasurement.objects.all():
            sm.temp_location = sm.location.unique_id
            sm.save()

        # Copy all Location objects into TempLocation
        for l in orm.Location.objects.all():
            tl = orm.TempLocation()
            tl.unique_id = l.unique_id
            tl.project = l.project
            tl.area = l.area
            tl.the_geom = l.the_geom
            tl.information = l.information
            tl.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 13, 47, 53, 263776)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 13, 47, 53, 263683)'}),
