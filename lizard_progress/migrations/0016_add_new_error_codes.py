...
MESSAGES = (
    ('MET_WATERWAY_TOO_WIDE', 'Maximale breedte van de watergang is {0}m.'),
    ('MET_Z_TOO_LOW', 'De laagst toegestane Z waarde is {0}.'),
    ('MET_INSIDE_EXTENT', '{0} buiten toegestane waarden ({1} - {2})'),
    ('MET_MEAN_MEASUREMENT_DISTANCE',
     'De gemiddelde afstand tussen punten binnen de watergang is {0}, maximum is {1}.'),
    ('MET_DIFFERENCE_Z1Z2_MAX_1M', 'Het maximale verschil tussen Z1 en Z2 is {0}m.'),
)
