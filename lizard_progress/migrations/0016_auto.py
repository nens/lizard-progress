...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field expected_attachments on 'Measurement'
        db.create_table(u'lizard_progress_measurement_expected_attachments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('measurement', models.ForeignKey(orm[u'lizard_progress.measurement'], null=False)),
            ('expectedattachment', models.ForeignKey(orm[u'lizard_progress.expectedattachment'], null=False))
        ))
        db.create_unique(u'lizard_progress_measurement_expected_attachments', ['measurement_id', 'expectedattachment_id'])


    def backwards(self, orm):
        # Removing M2M table for field expected_attachments on 'Measurement'
        db.delete_table('lizard_progress_measurement_expected_attachments')
