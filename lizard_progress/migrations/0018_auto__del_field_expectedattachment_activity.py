...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExpectedAttachment.activity'
        db.delete_column(u'lizard_progress_expectedattachment', 'activity_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ExpectedAttachment.activity'
        raise RuntimeError("Cannot reverse this migration. 'ExpectedAttachment.activity' and its values cannot be restored.")
