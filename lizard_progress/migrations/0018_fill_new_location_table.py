...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Fill the new Location table with data from the TempLocation
        for tl in orm.TempLocation.objects.all():
            l = orm.Location()
            l.location_code = tl.unique_id
            l.project = tl.project
            l.area = tl.area
            l.the_geom = tl.the_geom
            l.information = tl.information
            l.save()

        # Fill in the foreign key in ScheduledMeasurement using temp_location
        for sm in orm.ScheduledMeasurement.objects.all():
            sm.location = orm.Location.objects.get(location_code=sm.temp_location)
            sm.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 14, 6, 17, 730881)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 14, 6, 17, 730800)'}),
