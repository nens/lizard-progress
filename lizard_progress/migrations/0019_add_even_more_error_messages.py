...
MESSAGES = (
    ('MET_Z_TOO_LOW_BELOW_WATER', 'De laagst toegestane Z waarde is {0} ten opzichte van de waterstand (de waarde bij de 22 codes).'),
    ('MET_DISTANCE_TO_MIDLINE', 'De afstand van dit punt tot de lijn door de punten bij beide 22 codes is {0}m, het maximum is {1}m.'),
)
