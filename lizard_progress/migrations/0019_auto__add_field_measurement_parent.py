...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Measurement.parent'
        db.add_column(u'lizard_progress_measurement', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Measurement'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Measurement.parent'
        db.delete_column(u'lizard_progress_measurement', 'parent_id')
