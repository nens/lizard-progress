...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ScheduledMeasurement', fields ['project', 'temp_location', 'measurement_type', 'contractor']
        db.delete_unique('lizard_progress_scheduledmeasurement', ['project_id', 'temp_location', 'measurement_type_id', 'contractor_id'])

        # Removing unique constraint on 'TempLocation', fields ['unique_id', 'project']
        db.delete_unique('lizard_progress_templocation', ['unique_id', 'project_id'])

        # Deleting model 'TempLocation'
        db.delete_table('lizard_progress_templocation')

        # Deleting field 'ScheduledMeasurement.temp_location'
        db.delete_column('lizard_progress_scheduledmeasurement', 'temp_location')

        # Changing field 'ScheduledMeasurement.location'
        db.alter_column('lizard_progress_scheduledmeasurement', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lizard_progress.Location']))

        # Adding unique constraint on 'ScheduledMeasurement', fields ['project', 'measurement_type', 'location', 'contractor']
        db.create_unique('lizard_progress_scheduledmeasurement', ['project_id', 'measurement_type_id', 'location_id', 'contractor_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ScheduledMeasurement', fields ['project', 'measurement_type', 'location', 'contractor']
        db.delete_unique('lizard_progress_scheduledmeasurement', ['project_id', 'measurement_type_id', 'location_id', 'contractor_id'])

        # Adding model 'TempLocation'
        db.create_table('lizard_progress_templocation', (
            ...
            ('unique_id', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
        ))
        db.send_create_signal('lizard_progress', ['TempLocation'])

        # Adding unique constraint on 'TempLocation', fields ['unique_id', 'project']
        db.create_unique('lizard_progress_templocation', ['unique_id', 'project_id'])

        # Adding field 'ScheduledMeasurement.temp_location'
        db.add_column('lizard_progress_scheduledmeasurement', 'temp_location', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Changing field 'ScheduledMeasurement.location'
        db.alter_column('lizard_progress_scheduledmeasurement', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Location'], null=True))

        # Adding unique constraint on 'ScheduledMeasurement', fields ['project', 'temp_location', 'measurement_type', 'contractor']
        db.create_unique('lizard_progress_scheduledmeasurement', ['project_id', 'temp_location', 'measurement_type_id', 'contractor_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 14, 11, 7, 267086)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 14, 11, 7, 266674)'}),
