...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_progress_lizardconfiguration', (
        ...
        db.send_create_signal('lizard_progress', ['LizardConfiguration'])

        # Adding field 'Organization.lizard_config'
        db.add_column('lizard_progress_organization', 'lizard_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.LizardConfiguration'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LizardConfiguration'
        db.delete_table('lizard_progress_lizardconfiguration')

        # Deleting field 'Organization.lizard_config'
        db.delete_column('lizard_progress_organization', 'lizard_config_id')
