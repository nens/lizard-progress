...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'AvailableMeasurementType', fields ['slug']
        db.create_unique('lizard_progress_availablemeasurementtype', ['slug'])

        # Adding unique constraint on 'AvailableMeasurementType', fields ['name']
        db.create_unique('lizard_progress_availablemeasurementtype', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AvailableMeasurementType', fields ['name']
        db.delete_unique('lizard_progress_availablemeasurementtype', ['name'])

        # Removing unique constraint on 'AvailableMeasurementType', fields ['slug']
        db.delete_unique('lizard_progress_availablemeasurementtype', ['slug'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 16, 16, 28, 750538)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 16, 16, 28, 750450)'}),
