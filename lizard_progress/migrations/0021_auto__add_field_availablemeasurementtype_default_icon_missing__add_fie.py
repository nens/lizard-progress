...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AvailableMeasurementType.default_icon_missing'
        db.add_column('lizard_progress_availablemeasurementtype', 'default_icon_missing', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Adding field 'AvailableMeasurementType.default_icon_complete'
        db.add_column('lizard_progress_availablemeasurementtype', 'default_icon_complete', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AvailableMeasurementType.default_icon_missing'
        db.delete_column('lizard_progress_availablemeasurementtype', 'default_icon_missing')

        # Deleting field 'AvailableMeasurementType.default_icon_complete'
        db.delete_column('lizard_progress_availablemeasurementtype', 'default_icon_complete')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 16, 21, 11, 691668)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 16, 21, 11, 691584)'}),
        ...
        'lizard_progress.availablemeasurementtype': {
            ...
            'default_icon_complete': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            'default_icon_missing': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
