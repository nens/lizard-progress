...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LizardConfiguration.name'
        db.add_column('lizard_progress_lizardconfiguration', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LizardConfiguration.name'
        db.delete_column('lizard_progress_lizardconfiguration', 'name')
