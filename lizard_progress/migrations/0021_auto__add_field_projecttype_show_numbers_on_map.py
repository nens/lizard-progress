...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectType.show_numbers_on_map'
        db.add_column(u'lizard_progress_projecttype', 'show_numbers_on_map',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectType.show_numbers_on_map'
        db.delete_column(u'lizard_progress_projecttype', 'show_numbers_on_map')
