...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExportRun.generates_file'
        db.add_column('lizard_progress_exportrun', 'generates_file',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExportRun.generates_file'
        db.delete_column('lizard_progress_exportrun', 'generates_file')
