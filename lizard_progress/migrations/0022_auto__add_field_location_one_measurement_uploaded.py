...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.one_measurement_uploaded'
        db.add_column(u'lizard_progress_location', 'one_measurement_uploaded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.one_measurement_uploaded'
        db.delete_column(u'lizard_progress_location', 'one_measurement_uploaded')
