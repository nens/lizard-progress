...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_progress_userrole', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('lizard_progress', ['UserRole'])

        # Adding M2M table for field roles on 'UserProfile'
        db.create_table('lizard_progress_userprofile_roles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['lizard_progress.userprofile'], null=False)),
            ('userrole', models.ForeignKey(orm['lizard_progress.userrole'], null=False))
        ))
        db.create_unique('lizard_progress_userprofile_roles', ['userprofile_id', 'userrole_id'])


    def backwards(self, orm):
        # Deleting model 'UserRole'
        db.delete_table('lizard_progress_userrole')
