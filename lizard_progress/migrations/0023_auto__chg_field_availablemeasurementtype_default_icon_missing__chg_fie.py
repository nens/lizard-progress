...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AvailableMeasurementType.default_icon_missing'
        db.alter_column('lizard_progress_availablemeasurementtype', 'default_icon_missing', self.gf('django.db.models.fields.CharField')(default='TODO.png', max_length=50))

        # Changing field 'AvailableMeasurementType.default_icon_complete'
        db.alter_column('lizard_progress_availablemeasurementtype', 'default_icon_complete', self.gf('django.db.models.fields.CharField')(default='TODO.png', max_length=50))


    def backwards(self, orm):
        
        # Changing field 'AvailableMeasurementType.default_icon_missing'
        db.alter_column('lizard_progress_availablemeasurementtype', 'default_icon_missing', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'AvailableMeasurementType.default_icon_complete'
        db.alter_column('lizard_progress_availablemeasurementtype', 'default_icon_complete', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 16, 50, 12, 169978)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 16, 50, 12, 169788)'}),
