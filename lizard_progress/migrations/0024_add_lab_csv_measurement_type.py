...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.AvailableMeasurementType(
            name="Laboratorium CSV file",
            slug="laboratorium_csv",
            default_icon_missing="bullets/squarered16.png",
            default_icon_complete="bullets/squaregreen16.png").save()

    def backwards(self, orm):
        "Write your backwards methods here."

        orm.AvailableMeasurementType.objects.filter(
            slug="laboratorium_csv").delete()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 5, 12, 12, 44, 776735)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 5, 12, 12, 44, 776658)'}),
