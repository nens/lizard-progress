...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.measured_date'
        db.add_column(u'lizard_progress_location', 'measured_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.measured_date'
        db.delete_column(u'lizard_progress_location', 'measured_date')
