...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AvailableMeasurementType.can_be_displayed'
        db.add_column('lizard_progress_availablemeasurementtype', 'can_be_displayed', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AvailableMeasurementType.can_be_displayed'
        db.delete_column('lizard_progress_availablemeasurementtype', 'can_be_displayed')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 5, 13, 59, 1, 925075)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 5, 13, 59, 1, 924994)'}),
