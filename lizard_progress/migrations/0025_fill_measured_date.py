...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Loop over all locations that have a measurement with a date.
        locations = orm['lizard_progress.Location'].objects.filter(
            measurement__date__isnull=False)

        # Keep some counts to show some feedback.
