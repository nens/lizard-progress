...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExportRun.file_path'
        db.alter_column(u'lizard_progress_exportrun', 'file_path', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'ExportRun.file_path'
        db.alter_column(u'lizard_progress_exportrun', 'file_path', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
