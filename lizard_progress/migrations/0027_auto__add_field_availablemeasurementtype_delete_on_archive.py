...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AvailableMeasurementType.delete_on_archive'
        db.add_column(u'lizard_progress_availablemeasurementtype', 'delete_on_archive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AvailableMeasurementType.delete_on_archive'
        db.delete_column(u'lizard_progress_availablemeasurementtype', 'delete_on_archive')
