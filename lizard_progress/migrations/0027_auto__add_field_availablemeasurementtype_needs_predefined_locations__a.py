...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AvailableMeasurementType.needs_predefined_locations'
        db.add_column('lizard_progress_availablemeasurementtype', 'needs_predefined_locations', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'AvailableMeasurementType.needs_scheduled_measurements'
        db.add_column('lizard_progress_availablemeasurementtype', 'needs_scheduled_measurements', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'AvailableMeasurementType.description'
        db.add_column('lizard_progress_availablemeasurementtype', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AvailableMeasurementType.needs_predefined_locations'
        db.delete_column('lizard_progress_availablemeasurementtype', 'needs_predefined_locations')

        # Deleting field 'AvailableMeasurementType.needs_scheduled_measurements'
        db.delete_column('lizard_progress_availablemeasurementtype', 'needs_scheduled_measurements')

        # Deleting field 'AvailableMeasurementType.description'
        db.delete_column('lizard_progress_availablemeasurementtype', 'description')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 6, 10, 41, 41, 12591)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 6, 10, 41, 41, 12514)'}),
