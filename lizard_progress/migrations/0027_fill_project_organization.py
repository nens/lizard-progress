...
from lizard_progress import models as progressmodels
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for project in orm.Project.objects.filter(organization__isnull=True):
            user = project.superuser
            profile = orm.UserProfile.objects.get(user=user)
            project.organization = profile.organization
            project.save()
    ...
    models = {
        ...
        'lizard_progress.project': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_progress.Organization']", 'null': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
