...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.work_impossible'
        db.add_column(u'lizard_progress_location', 'work_impossible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.work_impossible'
        db.delete_column(u'lizard_progress_location', 'work_impossible')
    ...
    models = {
        ...
        u'lizard_progress.location': {
            ...
            'work_impossible': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
