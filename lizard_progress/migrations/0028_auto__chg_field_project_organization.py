...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lizard_progress_project', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['lizard_progress.Organization']))

    def backwards(self, orm):

        # Changing field 'Project.organization'
        db.alter_column('lizard_progress_project', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Organization'], null=True))
