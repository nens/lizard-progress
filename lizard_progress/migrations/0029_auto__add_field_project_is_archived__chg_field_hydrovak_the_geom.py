...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.is_archived'
        db.add_column('lizard_progress_project', 'is_archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Hydrovak.the_geom'
        db.alter_column('lizard_progress_hydrovak', 'the_geom', self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(srid=28992))

    def backwards(self, orm):
        # Deleting field 'Project.is_archived'
        db.delete_column('lizard_progress_project', 'is_archived')


        # Changing field 'Hydrovak.the_geom'
        db.alter_column('lizard_progress_hydrovak', 'the_geom', self.gf('django.contrib.gis.db.models.fields.LineStringField')(srid=28992))
