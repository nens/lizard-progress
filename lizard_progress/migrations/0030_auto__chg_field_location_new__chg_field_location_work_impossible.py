...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.new'
        db.alter_column(u'lizard_progress_location', 'new', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Location.work_impossible'
        db.alter_column(u'lizard_progress_location', 'work_impossible', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Location.new'
        db.alter_column(u'lizard_progress_location', 'new', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Location.work_impossible'
        db.alter_column(u'lizard_progress_location', 'work_impossible', self.gf('django.db.models.fields.BooleanField')())
