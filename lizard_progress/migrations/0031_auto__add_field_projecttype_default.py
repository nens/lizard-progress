...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectType.default'
        db.add_column('lizard_progress_projecttype', 'default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectType.default'
        db.delete_column('lizard_progress_projecttype', 'default')
