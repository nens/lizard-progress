...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lizard_progress_project', 'project_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.ProjectType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.project_type'
        db.delete_column('lizard_progress_project', 'project_type_id')
