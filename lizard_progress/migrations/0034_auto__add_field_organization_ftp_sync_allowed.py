...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.ftp_sync_allowed'
        db.add_column(u'lizard_progress_organization', 'ftp_sync_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.ftp_sync_allowed'
        db.delete_column(u'lizard_progress_organization', 'ftp_sync_allowed')
