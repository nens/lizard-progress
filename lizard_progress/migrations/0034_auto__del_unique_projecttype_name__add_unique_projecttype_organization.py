...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ProjectType', fields ['name']
        db.delete_unique('lizard_progress_projecttype', ['name'])

        # Adding unique constraint on 'ProjectType', fields ['organization', 'name']
        db.create_unique('lizard_progress_projecttype', ['organization_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectType', fields ['organization', 'name']
        db.delete_unique('lizard_progress_projecttype', ['organization_id', 'name'])

        # Adding unique constraint on 'ProjectType', fields ['name']
        db.create_unique('lizard_progress_projecttype', ['name'])
