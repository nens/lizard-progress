...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AcceptedFile'
        db.create_table(u'lizard_progress_acceptedfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Activity'])),
            ('rel_file_path', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
            ('file_size', self.gf('django.db.models.fields.IntegerField')()),
            ('last_downloaded_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('uploaded_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'lizard_progress', ['AcceptedFile'])


    def backwards(self, orm):
        # Deleting model 'AcceptedFile'
        db.delete_table(u'lizard_progress_acceptedfile')
    ...
    models = {
        ...
        u'lizard_progress.acceptedfile': {
            'Meta': {'object_name': 'AcceptedFile'},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lizard_progress.Activity']"}),
            'file_size': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_downloaded_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
