...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExportRun.error_message'
        db.add_column('lizard_progress_exportrun', 'error_message',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExportRun.error_message'
        db.delete_column('lizard_progress_exportrun', 'error_message')
