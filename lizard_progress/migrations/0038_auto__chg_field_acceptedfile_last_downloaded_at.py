...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AcceptedFile.last_downloaded_at'
        db.alter_column(u'lizard_progress_acceptedfile', 'last_downloaded_at', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'AcceptedFile.last_downloaded_at'
        db.alter_column(u'lizard_progress_acceptedfile', 'last_downloaded_at', self.gf('django.db.models.fields.DateTimeField')())
