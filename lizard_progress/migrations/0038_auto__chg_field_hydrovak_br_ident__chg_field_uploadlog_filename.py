...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hydrovak.br_ident'
        db.alter_column('lizard_progress_hydrovak', 'br_ident', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'UploadLog.filename'
        db.alter_column('lizard_progress_uploadlog', 'filename', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Hydrovak.br_ident'
        db.alter_column('lizard_progress_hydrovak', 'br_ident', self.gf('django.db.models.fields.CharField')(max_length=24))

        # Changing field 'UploadLog.filename'
        db.alter_column('lizard_progress_uploadlog', 'filename', self.gf('django.db.models.fields.CharField')(max_length=50))
