...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AvailableMeasurementType.implementation'
        db.add_column('lizard_progress_availablemeasurementtype', 'implementation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AvailableMeasurementType.implementation'
        db.delete_column('lizard_progress_availablemeasurementtype', 'implementation')
