...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AcceptedFile', fields ['activity', 'rel_file_path']
        db.create_unique(u'lizard_progress_acceptedfile', ['activity_id', 'rel_file_path'])


    def backwards(self, orm):
        # Removing unique constraint on 'AcceptedFile', fields ['activity', 'rel_file_path']
        db.delete_unique(u'lizard_progress_acceptedfile', ['activity_id', 'rel_file_path'])
