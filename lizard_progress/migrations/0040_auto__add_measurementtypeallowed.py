...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_progress_measurementtypeallowed', (
        ...
        db.send_create_signal('lizard_progress', ['MeasurementTypeAllowed'])


    def backwards(self, orm):
        # Deleting model 'MeasurementTypeAllowed'
        db.delete_table('lizard_progress_measurementtypeallowed')
