...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AcceptedFile.file_size'
        db.alter_column(u'lizard_progress_acceptedfile', 'file_size', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'AcceptedFile.file_size'
        db.alter_column(u'lizard_progress_acceptedfile', 'file_size', self.gf('django.db.models.fields.IntegerField')(default=0))
