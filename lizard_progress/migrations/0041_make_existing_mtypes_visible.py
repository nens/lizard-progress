...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Initially, all project-owning organizations will have access to all
        # existing mtypes.
        for organization in (
            orm['lizard_progress.Organization'].objects.filter(
                is_project_owner=True)):
            for amtype in (
                orm['lizard_progress.AvailableMeasurementType'].objects.all()):
                orm['lizard_progress.MeasurementTypeAllowed'].objects.create(
                    organization=organization, mtype=amtype, visible=True)
