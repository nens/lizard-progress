...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReviewProject.name'
        db.add_column(u'lizard_progress_reviewproject', 'name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)

        # Adding field 'ReviewProject.organization'
        db.add_column(u'lizard_progress_reviewproject', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lizard_progress.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReviewProject.name'
        db.delete_column(u'lizard_progress_reviewproject', 'name')

        # Deleting field 'ReviewProject.organization'
        db.delete_column(u'lizard_progress_reviewproject', 'organization_id')
