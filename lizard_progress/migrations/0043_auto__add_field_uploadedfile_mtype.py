...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UploadedFile.mtype'
        db.add_column('lizard_progress_uploadedfile', 'mtype',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.AvailableMeasurementType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UploadedFile.mtype'
        db.delete_column('lizard_progress_uploadedfile', 'mtype_id')
    ...
    models = {
        ...
        'lizard_progress.measurementtypeallowed': {
        ...
        'lizard_progress.organization': {
            ...
            'mtypes_allowed': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['lizard_progress.AvailableMeasurementType']", 'through': "orm['lizard_progress.MeasurementTypeAllowed']", 'symmetrical': 'False'}),
