...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReviewProject.slug'
        db.add_column(u'lizard_progress_reviewproject', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReviewProject.slug'
        db.delete_column(u'lizard_progress_reviewproject', 'slug')
