...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'lizard_progress_location', 'area_id')


    def backwards(self, orm):
        # Adding model 'Area'
        db.create_table(u'lizard_progress_area', (
        ...
        db.add_column(u'lizard_progress_location', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Area'], null=True, blank=True),
                      keep_default=False)
