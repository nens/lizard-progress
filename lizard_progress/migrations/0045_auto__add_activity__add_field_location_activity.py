...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field measurement_types on 'Activity'
        db.create_table(u'lizard_progress_activity_measurement_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activity', models.ForeignKey(orm[u'lizard_progress.activity'], null=False)),
            ('availablemeasurementtype', models.ForeignKey(orm[u'lizard_progress.availablemeasurementtype'], null=False))
        ))
        db.create_unique(u'lizard_progress_activity_measurement_types', ['activity_id', 'availablemeasurementtype_id'])

        # Adding M2M table for field contractors on 'Activity'
        db.create_table(u'lizard_progress_activity_contractors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activity', models.ForeignKey(orm[u'lizard_progress.activity'], null=False)),
            ('organization', models.ForeignKey(orm[u'lizard_progress.organization'], null=False))
        ))
        db.create_unique(u'lizard_progress_activity_contractors', ['activity_id', 'organization_id'])

        # Adding field 'Location.activity'
        db.add_column(u'lizard_progress_location', 'activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Activity'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field measurement_types on 'Activity'
        db.delete_table('lizard_progress_activity_measurement_types')

        # Removing M2M table for field contractors on 'Activity'
        db.delete_table('lizard_progress_activity_contractors')

        # Deleting field 'Location.activity'
        db.delete_column(u'lizard_progress_location', 'activity_id')
