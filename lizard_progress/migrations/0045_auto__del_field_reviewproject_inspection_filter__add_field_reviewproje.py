...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReviewProject.inspection_filter'
        db.delete_column(u'lizard_progress_reviewproject', 'inspection_filter')

        # Adding field 'ReviewProject.inspection_filler'
        db.add_column(u'lizard_progress_reviewproject', 'inspection_filler',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ReviewProject.inspection_filter'
        db.add_column(u'lizard_progress_reviewproject', 'inspection_filter',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ReviewProject.inspection_filler'
        db.delete_column(u'lizard_progress_reviewproject', 'inspection_filler')
