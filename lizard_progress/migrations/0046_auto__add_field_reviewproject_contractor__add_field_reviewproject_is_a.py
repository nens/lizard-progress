...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReviewProject.contractor'
        db.add_column(u'lizard_progress_reviewproject', 'contractor',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'reviewer', null=True, to=orm['lizard_progress.Organization']),
                      keep_default=False)

        # Adding field 'ReviewProject.is_archived'
        db.add_column(u'lizard_progress_reviewproject', 'is_archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReviewProject.contractor'
        db.delete_column(u'lizard_progress_reviewproject', 'contractor_id')

        # Deleting field 'ReviewProject.is_archived'
        db.delete_column(u'lizard_progress_reviewproject', 'is_archived')
    ...
    models = {
        ...
        u'lizard_progress.reviewproject': {
            ...
            'contractor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'reviewer'", 'null': 'True', 'to': u"orm['lizard_progress.Organization']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inspection_filler': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'is_archived': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'beheerder'", 'to': u"orm['lizard_progress.Organization']"}),
