...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReviewProject.shape_files'
        db.add_column(u'lizard_progress_reviewproject', 'shape_files',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReviewProject.shape_files'
        db.delete_column(u'lizard_progress_reviewproject', 'shape_files')
