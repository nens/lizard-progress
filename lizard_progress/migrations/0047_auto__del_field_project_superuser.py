...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.superuser'
        db.delete_column(u'lizard_progress_project', 'superuser_id')


    def backwards(self, orm):
        # Adding field 'Project.superuser'
        db.add_column(u'lizard_progress_project', 'superuser',
