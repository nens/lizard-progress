...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReviewProject.feature_collection_geojson'
        db.add_column(u'lizard_progress_reviewproject', 'feature_collection_geojson',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReviewProject.feature_collection_geojson'
        db.delete_column(u'lizard_progress_reviewproject', 'feature_collection_geojson')
    ...
    models = {
        ...
        u'lizard_progress.reviewproject': {
            ...
            'feature_collection_geojson': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'shape_files': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
