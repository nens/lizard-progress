...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'lizard_progress_scheduledmeasurement', ['project_id', 'measurement_type_id', 'location_id', 'contractor_id'])

        # Adding field 'ScheduledMeasurement.available_measurement_type'
        db.add_column(u'lizard_progress_scheduledmeasurement', 'available_measurement_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.AvailableMeasurementType'], null=True),
                      keep_default=False)

        # Adding field 'ScheduledMeasurement.organization'
        db.add_column(u'lizard_progress_scheduledmeasurement', 'organization',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ScheduledMeasurement.available_measurement_type'
        db.delete_column(u'lizard_progress_scheduledmeasurement', 'available_measurement_type_id')

        # Deleting field 'ScheduledMeasurement.organization'
        db.delete_column(u'lizard_progress_scheduledmeasurement', 'organization_id')

        # Adding unique constraint on 'ScheduledMeasurement', fields ['project', 'measurement_type', 'location', 'contractor']
        db.create_unique(u'lizard_progress_scheduledmeasurement', ['project_id', 'measurement_type_id', 'location_id', 'contractor_id'])
    ...
    models = {
        ...
        u'lizard_progress.scheduledmeasurement': {
            'Meta': {'unique_together': "((u'project', u'contractor', u'measurement_type', u'location', u'available_measurement_type', u'organization'),)", 'object_name': 'ScheduledMeasurement'},
