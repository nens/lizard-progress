...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReviewProject.progress'
        db.add_column(u'lizard_progress_reviewproject', 'progress',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReviewProject.progress'
        db.delete_column(u'lizard_progress_reviewproject', 'progress')
