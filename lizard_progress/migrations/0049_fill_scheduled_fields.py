...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for scheduled in orm['lizard_progress.ScheduledMeasurement'].objects.all():
            scheduled.available_measurement_type = scheduled.measurement_type.mtype
            scheduled.organization = scheduled.contractor.organization
            scheduled.save()
