...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UploadedFile.activity'
        db.add_column(u'lizard_progress_uploadedfile', 'activity',
    ...
    def backwards(self, orm):
        # Deleting field 'UploadedFile.activity'
        db.delete_column(u'lizard_progress_uploadedfile', 'activity_id')
