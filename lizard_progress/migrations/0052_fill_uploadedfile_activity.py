...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for uploaded in orm['lizard_progress.UploadedFile'].objects.all():
            activities = list(uploaded.project.activity_set.all())
            uploaded.activity = activities[0]
            uploaded.organization = uploaded.contractor.organization
            uploaded.save()
