...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UploadedFile.contractor'
        db.delete_column(u'lizard_progress_uploadedfile', 'contractor_id')

        # Deleting field 'UploadedFile.project'
        db.delete_column(u'lizard_progress_uploadedfile', 'project_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UploadedFile.contractor'
        raise RuntimeError("Cannot reverse this migration. 'UploadedFile.contractor' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'UploadedFile.project'
        raise RuntimeError("Cannot reverse this migration. 'UploadedFile.project' and its values cannot be restored.")
