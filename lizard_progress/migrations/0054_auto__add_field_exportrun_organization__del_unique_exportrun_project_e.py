...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ExportRun', fields ['project', 'exporttype', 'measurement_type', 'contractor']
        db.delete_unique(u'lizard_progress_exportrun', ['project_id', 'exporttype', 'measurement_type_id', 'contractor_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'ExportRun', fields ['project', 'exporttype', 'measurement_type', 'contractor']
        db.create_unique(u'lizard_progress_exportrun', ['project_id', 'exporttype', 'measurement_type_id', 'contractor_id'])
