...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExportRun.contractor'
        db.delete_column(u'lizard_progress_exportrun', 'contractor_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ExportRun.contractor'
        raise RuntimeError("Cannot reverse this migration. 'ExportRun.contractor' and its values cannot be restored.")
