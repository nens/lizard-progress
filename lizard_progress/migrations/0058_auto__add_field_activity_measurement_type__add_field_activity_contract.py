...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.measurement_type'
        db.add_column(u'lizard_progress_activity', 'measurement_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', null=True, to=orm['lizard_progress.AvailableMeasurementType']),
                      keep_default=False)

        # Adding field 'Activity.contractor'
        db.add_column(u'lizard_progress_activity', 'contractor',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', null=True, to=orm['lizard_progress.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Activity.measurement_type'
        db.delete_column(u'lizard_progress_activity', 'measurement_type_id')

        # Deleting field 'Activity.contractor'
        db.delete_column(u'lizard_progress_activity', 'contractor_id')
