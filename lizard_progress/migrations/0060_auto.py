...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'lizard_progress.activity': {
            ...
            'contractor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'null': 'True', 'to': u"orm['lizard_progress.Organization']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'measurement_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'null': 'True', 'to': u"orm['lizard_progress.AvailableMeasurementType']"}),
