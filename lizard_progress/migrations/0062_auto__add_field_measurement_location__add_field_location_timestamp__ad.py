...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'lizard_progress_measurement', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Location'], null=True),
                      keep_default=False)

        # Adding field 'Location.timestamp'
        db.add_column(u'lizard_progress_location', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 9, 16, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Location.complete'
        db.add_column(u'lizard_progress_location', 'complete',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'lizard_progress_measurement', 'location_id')

        # Deleting field 'Location.timestamp'
        db.delete_column(u'lizard_progress_location', 'timestamp')

        # Deleting field 'Location.complete'
        db.delete_column(u'lizard_progress_location', 'complete')
