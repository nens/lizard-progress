...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'lizard_progress_scheduledmeasurement')

        # Deleting field 'Measurement.scheduled'
        db.delete_column(u'lizard_progress_measurement', 'scheduled_id')


    def backwards(self, orm):
        # Adding model 'ScheduledMeasurement'
        db.create_table(u'lizard_progress_scheduledmeasurement', (
        ...
        db.send_create_signal(u'lizard_progress', ['ScheduledMeasurement'])


        # User chose to not deal with backwards NULL issues for 'Measurement.scheduled'
        raise RuntimeError("Cannot reverse this migration. 'Measurement.scheduled' and its values cannot be restored.")
