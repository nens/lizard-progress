...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'lizard_progress_uploadedfile', 'mtype_id')

        # Deleting field 'UploadedFile.organization'
        db.delete_column(u'lizard_progress_uploadedfile', 'organization_id')


    def backwards(self, orm):
        # Adding field 'UploadedFile.mtype'
        db.add_column(u'lizard_progress_uploadedfile', 'mtype',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.AvailableMeasurementType'], null=True),
                      keep_default=False)

        # Adding field 'UploadedFile.organization'
        db.add_column(u'lizard_progress_uploadedfile', 'organization',
