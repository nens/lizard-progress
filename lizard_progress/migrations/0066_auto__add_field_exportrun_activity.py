...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExportRun.activity'
        db.add_column(u'lizard_progress_exportrun', 'activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Activity'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExportRun.activity'
        db.delete_column(u'lizard_progress_exportrun', 'activity_id')
