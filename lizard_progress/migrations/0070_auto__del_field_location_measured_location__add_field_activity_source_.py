...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Location.measured_location'
        db.delete_column(u'lizard_progress_location', 'measured_location')

        # Adding field 'Activity.source_activity'
        db.add_column(u'lizard_progress_activity', 'source_activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_progress.Activity'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Location.measured_location'
        db.add_column(u'lizard_progress_location', 'measured_location',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(srid=28992, null=True),
                      keep_default=False)

        # Deleting field 'Activity.source_activity'
        db.delete_column(u'lizard_progress_activity', 'source_activity_id')
